...
const CartQuantity = () => {
  ...
  const totalQuantity = cart_items.reduce((total, item) => total + item.qty, 0);
  ...
  return (
    <div className={style.svgcart} onClick={handlecart}>
      <svg height="40px" width="80px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26">
        <g>
